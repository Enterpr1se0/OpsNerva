...
export function SSHWorkspacePage({hosts,shells,onCreated,onReconnected,refresh,onError}:{hosts:Host[];shells:SSHShell[];onCreated:(shell:SSHShell)=>void;onReconnected:(shell:SSHShell)=>void;refresh:()=>Promise<void>;onError:(message:string)=>void}){
