...
export function ToolEventCard({sessionID,entry:initialEntry,hosts,liveSSHTaskOwner,currentLiveSSHTask,onDisclosure}:ToolEventCardProps){
	...
	const view=useMemo(()=>buildToolEventView({entry,storedPayload,hosts,liveSSHTaskOwner,currentLiveSSHTask,t}),[entry,storedPayload,hosts,liveSSHTaskOwner,currentLiveSSHTask,t])
