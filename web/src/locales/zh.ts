const zh = {
  ...
  skills: {
    ...
    title: 'Skills',
    closeUpload: '关闭上传', uploadSkill: '上传 Skill', uploadPackage: '上传 Markdown、ZIP 或 7z 包',
    packageHelp: '每个 SKILL.md 目录安装为一个 Skill。', skillName: 'Skill 名称', choosePackage: '选择 .md、.zip 或 .7z',
  ...
  tool: {
    ...
    rawJson: '原始 JSON', fileDetails: '文件变更', diff: '文件差异', fileEdit: '编辑文件', bytesRead: '读取大小', nextOffset: '下一偏移', validated: '校验通过', mode: '权限模式', owner: '所有者', validator: '校验器', after: '修改后', index: '序号', key: '键', value: '值', stderrResult: 'STDERR / 结果', outputOmitted: '省略 {{count}} B', waitDeadline: '等待截止，任务继续运行', sensitive: '敏感内容已脱敏，请勿用占位内容覆盖原文件。',
