const zh = {
  ...
  auth: {
	...
	setupLabel: '首次启动', setupTitle: '创建管理员密码', setupText: '此密码由你设置，用于之后登录 OpsNerva。密码只保存为安全哈希，无法找回，请妥善保管。',
  ...
  settings: {
    ...
    fullAccessTitle: '启用 Full access？', fullAccessConfirm: 'Agent 与 MCP 操作将不经审批直接执行。',
  ...
  tool: {
    ...
    rawJson: '原始 JSON', fileEvidence: '文件变更', diff: '文件差异', fileEdit: '编辑文件', bytesRead: '读取大小', nextOffset: '下一偏移', validated: '校验通过', mode: '权限模式', owner: '所有者', validator: '校验器', after: '修改后', index: '序号', key: '键', value: '值', stderrResult: 'STDERR / 结果', outputOmitted: '省略 {{count}} B', waitDeadline: '等待截止，任务继续运行', sensitive: '敏感内容已脱敏，请勿用占位内容覆盖原文件。',
