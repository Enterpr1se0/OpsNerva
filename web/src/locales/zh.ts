const zh = {
  ...
  sshShell: {
    short: 'Shell', title: '交互式 SSH Shell', empty: '当前没有活动 Shell。',
    interactive: '交互终端', sensitivePlaceholder: '密码或其他敏感输入',
    toolActions: { start: '开启', input: '输入', status: '输出', list: '列表', interrupt: '中断', close: '关闭' },
    ...
    termination: { requested_close: '已主动关闭', service_stopped: '服务停止', remote_exit: '远端 Shell 已退出', remote_signal: '远端信号终止', connection_lost: 'SSH 连接异常断开', start_failed: 'Shell 启动失败' },
  },
  sshWorkspace: {
    ...
    deleteLabel: '删除远程文件', deleteTitle: '删除“{{name}}”？', deleteDescription: '{{path}} 将从远程主机删除，目录会递归删除。',
  ...
  config: {
    ...
    sections: '配置栏目', editor: '配置编辑', backToList: '返回列表',
  },
  proxies: {
    ...
    keepPassword: '留空保留当前密码', clearPassword: '清除已保存密码', authentication: '认证', passwordSaved: '已保存密码', noAuthentication: '无认证',
    saved: '{{name}} 已保存。', deleted: '{{name}} 已删除。', testPassed: '{{name}} 连接正常 · HTTP {{status}} · {{latency}} ms',
    emptyTitle: '没有代理', deleteDialogLabel: '永久删除代理', deleteTitle: '删除代理“{{name}}”？',
    deleteText: '代理配置和已保存密码将被永久删除。正在被模型、Tavily 或 SSH 主机使用的代理无法删除。',
  },
  extensions: {
  ...
  mcp: {
    ...
    deleteDialogLabel: '永久删除 MCP 服务', deleteTitle: '删除 MCP 服务“{{name}}”？', deleteText: '连接配置与已保存的密钥将被删除，模型将不再看到该服务提供的工具。此操作无法撤销。', title: 'MCP 服务',
    add: '添加服务',
  ...
  settings: {
    ...
    fullAccessTitle: '启用 Full access？', fullAccessConfirm: 'Agent 操作将跳过策略拦截和审批。',
    approvalExplanations: '人工审批说明',
    explanationSection: '审批 Agent',
    runnerReady: '可用', modelUnavailable: '不可用', commandAgent: '人工审批说明', modelProvider: '模型', requestTimeout: '超时时间',
  ...
  chat: {
    ...
    hostsCount: '{{count}} 台主机：{{names}}', noHosts: 'Agent 无可用主机', workspaceSelected: 'Workspace：{{id}}', noWorkspace: '未选择 Workspace', noModel: '没有活动模型',
    ...
    deleteDialogLabel: '永久删除会话', deleteTitle: '删除会话“{{title}}”？', deleteText: '会话中的消息与附件将被永久删除，无法恢复；已执行的命令仍保留在审计记录中。', cannotDelete: 'Agent 仍在运行', stopFailed: '无法停止 Agent：{{message}}',
  ...
  workspace: {
    noConfigured: '未配置 Workspace', localFiles: '本地文件', parent: '上级目录', uploadFile: '上传文件', refreshFiles: '刷新文件', switchWorkspace: '切换 Workspace', switching: '正在切换…', boundToConversation: '已绑定当前会话',
    ...
    emptyDirectory: '目录为空',
    uploaded: '已上传 · {{path}}', saved: '已保存 · {{path}}', deleted: '已彻底删除 · {{type}}', deleteFolderTarget: '文件夹及其全部内容', deleteFileTarget: '文件',
  ...
  approval: {
    ...
    sshShellWarning: '授权后，Agent 可在到期或关闭前持续向此主机输入命令；密码只能由你通过私密输入框发送。',
    ...
    review_allow: '建议允许', review_reject: '建议拒绝',
  ...
  models: {
    ...
    deleteText: '已保存的 API Key 也会被删除，此操作无法撤销。', deleteActiveText: '这是当前使用的提供商；删除后如有环境配置，将自动使用环境模型。', title: '模型提供商',
  ...
  audit: {
    ...
    columns: { time: '时间', operation: '操作', risk: '风险', status: '状态', host: '主机', exit: '退出码' }, unknownOperation: '未知操作',
  ...
  statusLabels: { pending: '待处理', completed: '已完成', partial: '部分成功', closed: '已关闭', expired: '已到期', failed: '失败', active: '进行中', running: '运行中', stopping: '停止中', stopped: '已停止', blocked: '已阻塞', in_progress: '执行中', ready: '就绪', error: '错误', connecting: '连接中', interrupted: '已中断', rejected: '已拒绝', approval_required: '待审批' },
  ...
  toolGuards: { read_only: '只读', policy_checked: '动态策略', approval_required: '审批控制', agent_state: 'Agent 状态', audited_control: '审计控制', external_mcp: '外部 MCP' },
  toolNames: {
