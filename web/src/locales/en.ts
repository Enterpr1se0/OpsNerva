const en = {
  ...
  sshShell: {
    short: 'Shells', title: 'Interactive SSH shells', empty: 'No interactive shell is active.',
    interactive: 'Interactive terminal', sensitivePlaceholder: 'Password or other sensitive input',
    toolActions: { start: 'Open', input: 'Input', status: 'Output', list: 'List', interrupt: 'Interrupt', close: 'Close' },
    ...
    termination: { requested_close: 'Closed by request', service_stopped: 'Service stopped', remote_exit: 'Remote shell exited', remote_signal: 'Stopped by remote signal', connection_lost: 'SSH connection lost', start_failed: 'Shell start failed' },
  },
  sshWorkspace: {
    ...
    deleteLabel: 'DELETE REMOTE ENTRY', deleteTitle: 'Delete “{{name}}”?', deleteDescription: '{{path}} will be deleted from the remote host. Directories are deleted recursively.',
  ...
  config: {
    ...
    sections: 'Configuration sections', editor: 'Configuration editor', backToList: 'Back to list',
  },
  proxies: {
    ...
    emptyTitle: 'No proxies', deleteDialogLabel: 'PERMANENT PROXY DELETION', deleteTitle: 'Delete proxy “{{name}}”?',
    deleteText: 'The proxy configuration and saved password will be permanently deleted. A proxy referenced by a model, Tavily, or SSH host cannot be deleted.',
  },
  extensions: {
  ...
  mcp: {
    ...
    deleteDialogLabel: 'PERMANENT MCP SERVER DELETION', deleteTitle: 'Delete MCP server “{{name}}”?', deleteText: 'Its connection settings and saved secrets will be deleted, and its tools will disappear from the model. This action cannot be undone.', title: 'MCP servers',
    add: 'Add server',
  ...
  settings: {
    ...
    fullAccessTitle: 'Enable Full access?', fullAccessConfirm: 'Agent operations will bypass policy blocks and approval.',
    approvalExplanations: 'Human approval details',
    explanationSection: 'Approval Agent',
    runnerReady: 'Available', modelUnavailable: 'Unavailable', commandAgent: 'Human approval details', modelProvider: 'Model', requestTimeout: 'Timeout',
  ...
  chat: {
    ...
    deleteDialogLabel: 'PERMANENT CONVERSATION DELETION', deleteTitle: 'Delete conversation “{{title}}”?', deleteText: 'Its messages and attachments will be deleted and cannot be recovered. Executed commands stay in the audit log.', cannotDelete: 'Agent is still running', stopFailed: 'Unable to stop Agent: {{message}}',
  ...
  workspace: {
    noConfigured: 'No Workspace configured', localFiles: 'Local files', parent: 'Parent directory', uploadFile: 'Upload file', refreshFiles: 'Refresh files', switchWorkspace: 'Switch Workspace', switching: 'Switching…', boundToConversation: 'Bound to this conversation',
    ...
    uploaded: 'Uploaded · {{path}}', saved: 'Saved · {{path}}', deleted: 'Deleted permanently · {{type}}', deleteFolderTarget: 'folder and all of its contents', deleteFileTarget: 'file',
  ...
  tool: {
    bashScript: 'Bash script', moreLines: '{{line}} ... (+{{count}} lines)', latestStdout: 'STDOUT · latest {{count}} lines', fileOperation: 'File operation', readOperation: 'Read file', searchOperation: 'Search file',
  ...
  approval: {
    ...
    hostShell: 'Host', deadline: 'Deadline', digest: 'Request digest', sourceSHA: 'Source SHA256', destinationSHA: 'Destination SHA256',
    ...
    sshShellWarning: 'After approval, the Agent may continue entering commands on this host until the shell expires or is closed. Only you can send passwords through the private input.',
    ...
    review_allow: 'Allow recommended', review_reject: 'Reject recommended',
  ...
  models: {
    ...
    deleteDialogLabel: 'PERMANENT PROVIDER DELETION', deleteTitle: 'Delete model provider “{{name}}”?',
    deleteText: 'Its saved API key will also be deleted. This action cannot be undone.', deleteActiveText: 'This is the active provider; environment model settings will be used when available.', title: 'Model providers',
  ...
  audit: {
    ...
    columns: { time: 'Time', operation: 'Operation', risk: 'Risk', status: 'Status', host: 'Host', exit: 'Exit' }, unknownOperation: 'Unknown operation',
  ...
  statusLabels: { pending: 'pending', completed: 'completed', partial: 'partial', closed: 'closed', expired: 'expired', failed: 'failed', active: 'active', running: 'running', stopping: 'stopping', stopped: 'stopped', blocked: 'blocked', in_progress: 'in progress', ready: 'ready', error: 'error', connecting: 'connecting', interrupted: 'interrupted', rejected: 'rejected', approval_required: 'approval required' },
  ...
  toolGuards: { read_only: 'Read only', policy_checked: 'Dynamic policy', approval_required: 'Approval control', agent_state: 'Agent state', audited_control: 'Audited control', external_mcp: 'External MCP' },
  toolNames: {
