const en = {
  ...
  approval: {
    ...
    allowSession: 'Allow the same operation in this session', hostUnavailable: 'Unavailable for host commands', fileReadUnavailable: 'File content access requires separate approval every time', criticalUnavailable: 'Unavailable for high-risk operations',
  ...
  models: {
    ...
    deleteText: 'Its saved API key and proxy credentials will also be deleted. This action cannot be undone.', deleteActiveText: 'This is the active provider; environment model settings will be used when available.', title: 'Model providers',
