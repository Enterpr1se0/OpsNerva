const en = {
  ...
  auth: {
	...
	setupLabel: 'FIRST START', setupTitle: 'Create administrator password', setupText: 'Choose the password used to sign in to OpsNerva. Only a secure hash is stored, so keep the password somewhere safe.',
  ...
  settings: {
    ...
    fullAccessTitle: 'Enable Full access?', fullAccessConfirm: 'Agent and MCP operations will run without approval.',
