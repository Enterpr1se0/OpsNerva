const en = {
  ...
  approval: {
    actionScript: 'script', actionCommand: 'command', sudoFileTitle: 'Allow root to modify this system file?', sudoTitle: 'Allow this {{kind}} to run as root?',
    ...
    pendingOperation: 'Pending operation', approved: 'Approved · {{status}} · {{run}}', autoApproved: 'Auto approved',
  ...
  hosts: {
    authAgent: 'SSH agent', authKey: 'Use private key', authPassword: 'Account password', sudoNone: 'user only', sudoNopasswd: 'root (no password)', sudoPassword: 'root (managed password)',
    ...
    proxyJump: 'SSH jump host', direct: 'Direct connection', proxy: 'Proxy', knownHosts: 'Known hosts file', useDefault: 'Use system default', sudoPolicy: 'root access', sudoPasswordLabel: 'root password',
