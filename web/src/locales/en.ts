const en = {
  ...
  chat: {
    ...
    waitingModel: 'Waiting for model response', retryingModel: 'Model request failed; retrying', backgroundRunning: 'Running in the background. Reloading will not interrupt it.',
  ...
  tool: {
    ...
    actualParameters: 'Actual call parameters', parameter: 'Parameter',
  ...
  approval: {
    ...
    uploadTitle: 'Allow this file upload?', transferTitle: 'Allow this host-to-host file transfer?', tunnelTitle: 'Allow this local SSH port forward?', hostShellTitle: 'Allow this script to run on the host?', fileTitle: 'Allow this file change?', executeTitle: 'Allow this {{kind}} to run?',
    uploadLabel: 'File to upload', transferLabel: 'File transfer', tunnelLabel: 'Port forwarding route', rootFileLabel: 'File to modify as root', rootCommandLabel: 'Full {{kind}} to execute as root', fileLabel: 'File to modify', commandLabel: 'Full {{kind}} to execute',
    ...
    plainExplanation: 'Command details', risks: 'Risks', degradedInfo: 'Errors',
    ...
    allowSession: 'Allow the same operation in this session', hostUnavailable: 'Unavailable for host commands', fileReadUnavailable: 'File content access requires separate approval every time', tunnelSessionUnavailable: 'Starting a port forward requires separate approval every time', criticalUnavailable: 'Unavailable for high-risk operations',
  ...
  statusLabels: { pending: 'pending', completed: 'completed', failed: 'failed', active: 'active', running: 'running', stopping: 'stopping', stopped: 'stopped', blocked: 'blocked', in_progress: 'in progress', ready: 'ready', error: 'error', connecting: 'connecting', interrupted: 'interrupted', rejected: 'rejected', approval_required: 'approval required' },
  ...
  toolNames: {
    ...
    ssh_task: 'Manage background task', ssh_tunnel: 'Manage SSH port forwarding', ssh_host_list: 'List hosts', ssh_host_inspect: 'Inspect host',
